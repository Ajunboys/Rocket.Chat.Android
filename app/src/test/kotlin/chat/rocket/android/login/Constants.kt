...
const val ME_SUCCESS = "{\"_id\":\"userId\",\"name\":\"validUsername\",\"emails\":[{\"address\":\"validUsername@email.com\",\"verified\":false}],\"status\":\"offline\",\"statusConnection\":\"offline\",\"username\":\"validUsername\",\"utcOffset\":-2,\"active\":true,\"success\":true}"
